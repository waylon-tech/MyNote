...
// DESC: 这是一个内部头文件，被 STL 标准头文件 <iterator> 包含。
...
// ----------------------------------------
// iterator_category 五种迭代器类型标记（这个属于 STL 标准）
...
// ----------------------------------------
// 标准迭代器的基类（用户自己的写的迭代器最好继承此 std::iterator）
...
// 针对原生指针 (native pointer) 而设计的 traits 偏特例化版本
template <class _Tp>
...
// 针对原生之 pointer-to-const 而设计的 traits 偏特例化版本
template <class _Tp>
